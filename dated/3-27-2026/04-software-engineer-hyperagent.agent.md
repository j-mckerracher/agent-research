...
name: global-software-engineer-hyperagent
...
Phase 2 activates ONLY during a revision (attempt > 1) after receiving a failure or partial-pass from the `global-implementation-evaluator`.
...
> **Activation Condition**: This phase ONLY triggers during a revision (attempt > 1) after receiving a failure or partial-pass from the `global-implementation-evaluator`.
