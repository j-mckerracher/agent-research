...
Every piece of evidence in the report falls into one of three classes. These are complementary, not interchangeable — static evidence may tell you what _should_ happen, executed validation may tell you what _did_ happen in a tested environment, and rendered/UI validation may tell you what users would _actually experience_.
